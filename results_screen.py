...
def make_window(parameters, response, dataMaxes, sort_on="score", default_sort_val="Highest Score"):
    ...
    layout = [[Menu([['File', ['Exit']], ['Edit', ['Edit Me', ]]], k='-CUST MENUBAR-', p=0)],
              ...
              [sg.HSep()],
              [sg.Text("# of Viable Options: " + str(len(bids)) + " | "), sg.Text("Sort: "),
               sg.OptionMenu(['Highest Score', 'Fastest', 'Cheapest', 'Lightest', 'Firmest'], s=(15, 2),
              ...
              [sg.Text("Cost: " + str(round(cost_coef, 3))),
               ...
               sg.Push(), sg.Button("Change Objective Parameters",
